...
public class EventController {
    ...
    public ResponseEntity<EventDTO> createEvent(@RequestBody EventDTO eventDto) throws EventCreationException {
        ...
        Event newEvent = eventRepo.save(EventEntity.builder()
            ...
            .shortDescription(eventDto.getShortDescription())
            .thumbnailFileName(eventDto.getThumbnailFileName())
            .thumbnailXOffset(eventDto.getThumbnailXOffset())
            .thumbnailYOffset(eventDto.getThumbnailYOffset())
            .thumbnailZoomOffset(eventDto.getThumbnailZoomOffset())
    ...
    public ResponseEntity<List<EventDTO>> getEvents() {
        ...
        List<EventDTO> events = Streamable.of(eventRepo.findAll())
            ...
            .map(ee -> EventDTO.builder()
                ...
                .thumbnailXOffset(ee.getThumbnailXOffset())
                .thumbnailYOffset(ee.getThumbnailYOffset())
                .thumbnailZoomOffset(ee.getThumbnailZoomOffset())
                .date(ee.getDate())
